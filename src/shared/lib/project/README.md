...
- `preset.ts` — пресеты: подграф ОДНОЙ выходной ветки (операции + params, без файлов/путей).
  `extractBranch` / применение. _(пункт 3 Спринта 4)_
...
(версионирование, устойчивость к мусору). Реестр — `tests/README.md`.
